Feature: Testing arithmetic operations for a simple calculator
  ...
  Scenario: As a student, I want to execute sum up operations on numbers, so I can see the correct results
    Given I have a calculator
    When I sum up 7 and 8
    Then I expect the result to be 15


  Scenario: As a student, I want to execute substract operations on numbers, so I can see the correct results
    Given I have a calculator
    When I substract 10 from 20
    Then I expect the result to be 10


  Scenario: As a student, I want to execute multiplications operations on numbers, so I can see the correct results
    Given I have a calculator
